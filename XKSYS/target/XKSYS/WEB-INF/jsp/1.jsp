...
option = {
    title: {
        text: '店铺全国分布图',
        subtext: 'data from lxc，thanks',
        sublink: 'https://user.qzone.qq.com/2592708986?source=aiostar',
        left: 'center'
    },
    tooltip : {
        trigger: 'item'
...
if (option && typeof option === "object") {
    myChart.setOption(option, true);
       ...
       <form name="select" action="${pageContext.request.contextPath }/two.action" method="post">
